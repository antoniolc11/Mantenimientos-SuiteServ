        ...
        <div id="modalEdit{{ $ubicacion->id }}" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-start justify-between p-1 border-b rounded-t dark:border-gray-600 bg-black">
                        <button type="button"
                            ...
                            data-modal-hide="modalEdit{{ $ubicacion->id }}">
                    ...
                    <form action="{{ route('ubicaciones.update', $ubicacion) }}" method="POST">
                        ...
                        <div class="p-6 space-y-6">
                            <div class="mb-6">
                                ...
                                <x-input-label for="nombre" :value="__('Nombre ubicacion')"
                                ...
                                <x-text-input id="nombredepart" class="block mt-1 w-full" type="text"
                                    name="nombre" value="{{ $ubicacion->nombre }}" required autofocus
                                    autocomplete="nombre" />
                        ...
                        <div
                            ...
                            <!-- Botón "Cancelar" -->
                            <button data-modal-hide="modalEdit{{ $ubicacion->id }}" type="button"
