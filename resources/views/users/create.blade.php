<x-app-layout>
    ...
    <h2 class="text-lg font-semibold text-gray-700 capitalize dark:text-white">Ficha de registro</h2>
            <form class="flex flex-col pt-3 md:pt-8" method="POST" action="{{ route('users.store') }}">
                ...
                <div>
                    ...
                    <x-text-input id="nombre" class="block mt-1 w-full" type="text" name="nombre"
                        :value="old('nombre')" required autofocus autocomplete="nombre" placeholder="Ingresa tu primer nombre" />
                ...
                <div>
                    ...
                    <x-text-input id="primer_apellido" class="block mt-1 w-full" type="text" name="primer_apellido"
                        :value="old('primer_apellido')" required autofocus autocomplete="primer_apellido" placeholder="Ingresa tu primer apellido"/>
                ...
                <div>
                    ...
                    <x-text-input id="segundo_apellido" class="block mt-1 w-full" type="text" name="segundo_apellido"
                        :value="old('segundo_apellido')" required autofocus autocomplete="segundo_apellido" placeholder="Ingresa tu segundo apellido"/>
                ...
                <div>
                    ...
                    <select name="departamento" id="departamento"  class="block w-full px-4 py-2 mt-1 text-gray-700 bg-white border border-black rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:outline-none focus:ring focus:ring-black focus:ring-opacity-100 focus:border-transparent hover:border-gray-300 hover:bg-transparent'>
                        ">
