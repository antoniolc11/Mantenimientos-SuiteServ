      ...
      <div id="cerrar-modal{{ $incidencia->id }}" tabindex="-1"
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 ">
                <button type="button"
                    ...
                    data-modal-toggle="cerrar-modal{{ $incidencia->id }}">
                ...
                <div class="p-6 text-center">
                    <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 512 512" aria-hidden="true" class="mx-auto mb-4 w-10 h-10 text-green-400 dark:text-gray-200"
                    ...
                    <h3 class="mb-5 text-lg font-normal text-black  dark:text-gray-400">¿Seguro que desea pasar a finalizada la incidencia?</h3>
                    <form action="{{ route('incidencias.cerrar', $incidencia) }}" method="POST"
                        class="inline">
                        @method('put')
                        @csrf

                        <button data-modal-toggle="cerrar-modal{{ $incidencia->id }}" type="submit"
                        ...
                        <button data-modal-toggle="cerrar-modal{{ $incidencia->id }}" type="button"
