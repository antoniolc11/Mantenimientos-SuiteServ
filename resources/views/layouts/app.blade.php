...
<head>
    ...
    <!-- Tailwind -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/habibmhamadi/multi-select-tag/dist/css/multi-select-tag.css"> {{-- //js para añadir multiples departamento a la hora de crear un usuario. --}}
