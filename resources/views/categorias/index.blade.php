<x-app-layout>
                ...
                <div class="p-3 text-gray-900 dark:text-gray-100">
                    ...
                    <table id="tablaEstados" class="min-w-full text-feft text-sm font-light ">
                        <thead
                            ...
                            <tr>
                                <th scope="col" class=" px-6 py-4">Categorías</th>
                                ...
                                <tr class="border-b dark:border-neutral-500">
                                    ...
                                    <td class="px-6 text-center">
                                        <button type="button"
                                            ...
                                            data-modal-target="modalEdit{{ $categoria->id }}"
                                            data-modal-toggle="modalEdit{{ $categoria->id }}">
    ...
    @foreach ($categorias as $categoria)
        <!-- Ventana modal para editar un cateegoria -->
